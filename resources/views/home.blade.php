...
<div class="container-fluid">
    <div class="">
        ...
        <div class="mx-auto" style="max-width:1200px">
            ...
            ログインしました。←フラッシュメッセージにしたい（ログインした直後だけ表示）
            <div class=”container”>
                                    ...
                                    <table class="table table-fixed">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="{{ url('/stock').'/'.$inspection_item->id}}" class="">{{$inspection_item->name}}</a></td>
            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    <div class="card">
                        <div class="card-header"> {{Auth::user()->name}}さんの作品が売れた履歴<(取得件数を直近30件とかにしたい)</div> <div
                                class="card-body">
                                @if (session('status'))
